  ...
  <div class="flex items-center justify-center mt-8">
    <div class="w-full max-w-md py-5 px-3">
      ...
      >
        ...
        <span class="text-red-500 font-medium py-2 text-xs" v-if="errorStatus">{{
          errorMessage
        }}</span>
        <span
          v-if="errorCode == 404 && errorStatus == true"
          class="text-indigo-500 font-medium py-2 underline text-sm cursor-pointer"
          @click.prevent="resendOtp"
          >Kirim ulang OTP?</span
        >
        <div class="mt-4 mb-3 flex items-center justify-between">
          <button
            class="px-6 py-2 min-w-1/3 rounded text-white shadow-lg bg-indigo-500 hover:bg-indigo-600 focus:bg-indigo-700"
            type="submit"
          >
