<template>
  <div class="flex items-center justify-center bg-indigo-100">
    <div class="bg-white rounded-lg shadow-md my-16 p-8 xs:px-2 xs:py-4 xs:mx-4">
      <div class="px-2 pb-4">
      ...
      <div class="flex justify-between">
        <div v-for="(l, i) in pinlength" :key="`codefield_${i}`">
          <input
            ...
            class="border border-indigo-400 border mx-2 rounded flex items-center text-center h-16 w-12 text-3xl xs:h-12 xs:w-10 xs:text-2xl"
            value=""
            maxlength="1"
            max="9"
            min="0"
