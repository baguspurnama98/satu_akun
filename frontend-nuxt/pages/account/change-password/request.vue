...
<template>
    ...
    <div class="flex items-center justify-center mt-8">
        <div class="w-full max-w-md py-5 px-3">
            <div v-show="errorStatus" class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative w-full max-w-md mb-5" role="alert">
                <strong class="font-bold">Akun tidak terdaftar.</strong>
                <span class="block sm:inline">Masukkan alamat email terdaftar.</span>
                <span @click.prevent="errorStatus = false" class="absolute top-0 bottom-0 right-0 px-2 py-3">
