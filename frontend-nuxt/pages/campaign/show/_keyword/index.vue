<template>
  <div
    class="container px-4 my-5 mx-auto flex-wrap justify-between min-h-screen"
  >
    <header>
      <div class="container mx-auto px-6 py-3">
        ...
        <div
          class="relative items-center text-gray-900 my-5 xs:mb-5 w-1/2 xs:w-full mx-auto"
        >
          <input
            type="search"
            name="serch"
