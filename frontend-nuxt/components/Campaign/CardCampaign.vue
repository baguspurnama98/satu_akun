    ...
    <a href="/campaign/1">
      ...
      <div class="px-3 mt-4">
        <div class="col-span-3 row-span-1">
          ...
          >
            <h1 class="text-xl xs:text-xs font-medium truncate">
              {{ title }}
            </h1>
          </header>
        </div>

        <div class="col-span-3 row-span-1 mb-2">
          <a class="text-sm xs:text-xs" href="#">
        ...
        <div class="col-span-3 row-span-1 pt-1 pb-0">
          ...
          <div class="flex-1 inline-flex items-center">
            <svg
              class="h-4 w-4 text-black-300 mr-1"
        ...
        <div class="col-span-3 row-span-1 pb-4">
          ...
          >
            <div class="col-end-7 col-span-2">
              <span class="text-red-700 text-sm xs:text-xs">3 hari lagi </span>
            </div>
          </div>
        </div>
