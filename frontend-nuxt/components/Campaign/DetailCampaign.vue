    ...
    >
      <div class="col-start-1 px-3 mt-5 mb-2">
        ...
        <!-- <div class="text-right pr-3">
          <span class="italic text-sm rounded-full px-2 py-1 bg-yellow-200"
            >Ayo <span class="font-medium">Bagus</span> tinggal
            <span class="font-medium">2 </span> slot lagi!</span
          >
        </div> -->
      </div>
