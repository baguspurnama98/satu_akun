<template>
  <div>
    <section
      class="h-full w-full border-box lg:px-24 md:px-16 sm:px-8 px-8 transition-all duration-500 linear"
    >
      <div style="font-family: 'Poppins', sans-serif">
        <div
          class="container mx-auto flex pt-8 sm:pb-16 pb-8 items-center justify-center flex-col"
        >
          <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
          viewBox="0 0 800 600" class="max-w-full md:max-w-md">
          <g>
            <defs>
          ...
          <div class="text-center w-full">
            <h1 class="title-text-2-3 text-2xl my-10 font-semibold text-indigo-500">
