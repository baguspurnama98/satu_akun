<template>
  <div>
    <section
      class="w-full min-h-screen border-box lg:px-24 md:px-16 sm:px-8 px-8 transition-all duration-500 linear"
    >
      <div class="container mx-auto flex items-center justify-center flex-col">
        <div v-once ref="animation" class="xs:-mt-20 -mt-40"></div>

        <div class="text-center w-full -mt-20">
          <h1 class="title-text-2-3 text-2xl my-5 font-semibold text-indigo-500">
