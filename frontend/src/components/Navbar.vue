<template>
<nav id="wrapper" class="p-4 sticky w-full z-10 top-0 shadow-lg bg-indigo-500 mb-6">
    <div class="container px-4 mx-auto flex flex-wrap items-center justify-between">
        ...
        <div class="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden lg:block pt-6 lg:pt-0" id="nav-content">
            <ul class="list-reset lg:flex justify-end flex-1 items-center">
                <li class="nav-item">
                    <a class="px-3 py-2 inline-block items-center leading-snug text-white hover:bg-gray-900 hover:text-gray-100" href="#pablo">
                        Layanan
                    </a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item ml-0 mt-2 lg:mt-0 lg:ml-2">
                    <button class="px-5 py-2 rounded inline-block bg-white hover:bg-gray-900 hover:text-white" type="button">
                        Masuk
                    </button>
                </li>
            </ul>
