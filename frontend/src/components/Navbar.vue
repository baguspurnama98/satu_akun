...
<div>
  ...
  <nav
    id="wrapper"
    class="p-4 relative sticky w-full z-10 top-0 shadow-xl bg-indigo-500 mb-6"
  >
    <div
    ...
    >
      ...
      >
        <ul class="list-reset lg:flex justify-end flex-1 items-center">
          <li class="nav-item">
            <a
              class="px-3 py-2 inline-block items-center leading-snug text-white hover:opacity-80"
              href="#pablo"
            >
          ...
          <li class="nav-item ml-4 mt-2 lg:mt-0">
            <button
              class="px-4 py-2 rounded inline-block bg-white hover:bg-red-500 hover:text-white"
              type="button"
            >
              Masuk
            </button>
